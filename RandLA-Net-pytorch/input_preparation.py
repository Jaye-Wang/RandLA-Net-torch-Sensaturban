...
if __name__ == '__main__':
    ...
    dataset_name = 'Houston18'
    dataset_path = FLAGS.dataset_path
    preparation_types = ['grid']  # Grid sampling & Random sampling
    grid_size = 0.2
    random_sample_ratio = 10
    train_files = np.sort([join(dataset_path, 'train_ply', i) for i in os.listdir(join(dataset_path, 'train_ply'))])
    ...
    for sample_type in preparation_types:
        for pc_path in files:
            ...
            if pc_path in train_files:
                ...
                xyz = DP.read_ply_data(pc_path, with_rgb=False, with_label=False)
            ...
            if sample_type == 'grid':
                ...
                sub_xyz, sub_labels = DP.random_sub_sampling(xyz, labels, random_sample_ratio)
