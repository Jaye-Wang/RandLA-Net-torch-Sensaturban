...
from houston_dataset import Houston,HoustonSampler
import numpy as np
import os, argparse
...
log_file_name = f'log_train_Houston.txt'
...
training_dataset = HoustonSampler(dataset, 'training')
validation_dataset = HoustonSampler(dataset, 'validation')
